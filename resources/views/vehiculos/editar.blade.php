...
<section class="section">
    ...
    <div class="section-body">
                ...
                <div class="card">
                    ...
                    <div class="col-md-3 col-xs-3 col-xs-3">
                     ...
                     <select name="TipoVehiculo" class="form-control">
                        <option value="">-</option>
                        <option  {{$vehiculos->TipoVehiculo =="AUTOMOVIL" ? 'selected':''}}>AUTOMOVIL</option>
                        <option {{$vehiculos->TipoVehiculo =="BUS" ? 'selected':''}}>BUS</option>
                        <option {{$vehiculos->TipoVehiculo =="CAMIONETA" ? 'selected':''}}>CAMIONETA</option>
                        <option {{$vehiculos->TipoVehiculo =="MOTOCICLETA" ? 'selected':''}}>MOTOCICLETA</option>
                        <option {{$vehiculos->TipoVehiculo =="PICK-UP" ? 'selected':''}}>PICK-UP</option>
                        <option {{$vehiculos->TipoVehiculo =="SUV" ? 'selected':''}}>SUV</option>
                        <option {{$vehiculos->TipoVehiculo =="TRAILER" ? 'selected':''}}>TRAILER</option>
                        <option {{$vehiculos->TipoVehiculo =="VAN" ? 'selected':''}}>VAN</option>
                    </select>
        ...
        <div class="col-md-3 col-xs-3 col-xs-3">
           ...
           <input type="text" name="Estadisticas" class="form-control" value=" {{$vehiculos->Estadisticas}}" id="datepicker">
       </div>
